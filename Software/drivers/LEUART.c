...
2016-02-23,rage	Added drvLEUART_Deinit() and IsDmaTransferDone().
2016-02-10,rage	Initial version, taken from SNB_Heaven.
*/
...
/* Setting up channel descriptorfor Tx  */
 ...
 *
 * This routine tells the caller if the DMA has completed.
 *
 * @return
 ...
 * interrupt is enabled.  The interrupt will be handled by DMA_IRQHandler().
 *
 *****************************************************************************/
...
/**************************************************************************//**
 * @brief  Deinitialize Low Energy UART
 *
