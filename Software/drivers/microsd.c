 ...
 ****************************************************************************//*
Revision History:
2018-02-20,rage	Added global variables g_MicroSD_PwrPort and g_MicroSD_PwrPin,
		which can be changed by platform detection logic.
...
/*================================== Macros ==================================*/
    ...
    /*!@brief Set the power enable pin. */
#define SET_MICROSD_PWR_PIN	GPIO->P[g_MicroSD_PwrPort].DOUTSET \
					= (1<<g_MicroSD_PwrPin)

    /*!@brief Clear the power enable pin. */
#define CLR_MICROSD_PWR_PIN	GPIO->P[g_MicroSD_PwrPort].DOUTCLR \
					= (1<<g_MicroSD_PwrPin)
...
/*! @brief Power Enable GPIO Port */
GPIO_Port_TypeDef	g_MicroSD_PwrPort = DFLT_MICROSD_PWR_GPIO_PORT;
/*! @brief Power Enable GPIO Pin */
int			g_MicroSD_PwrPin  = DFLT_MICROSD_PWR_PIN;
