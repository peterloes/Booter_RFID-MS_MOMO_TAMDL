...
//@{
	// APRDL or MAPRDL
#define DFLT_MICROSD_PWR_GPIO_PORT  gpioPortD	//!< Port for Power Enable
#define DFLT_MICROSD_PWR_PIN	0		//!< Power Enable Pin
	// TAMDL
#define TAMDL_MICROSD_PWR_GPIO_PORT gpioPortC	//!< Port for Power Enable
#define TAMDL_MICROSD_PWR_PIN	10		//!< Power Enable Pin
...
extern GPIO_Port_TypeDef	g_MicroSD_PwrPort;
extern int			g_MicroSD_PwrPin;
